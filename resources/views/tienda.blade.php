...
<body class="bg-gray-900 text-white min-h-screen px-6 py-12">
    ...
    <div class="max-w-5xl mx-auto">
        <h2 class="text-3xl font-bold text-yellow-400 mb-8 text-center">🛒 Tienda de objetos</h2>
        ...
        <div class="text-center mt-10">
            <a href="{{ route('dashboard') }}" class="bg-yellow-500 text-gray-900 px-4 py-2 rounded shadow hover:bg-yellow-600">
                Volver
            </a>
        </div>
    </div>
